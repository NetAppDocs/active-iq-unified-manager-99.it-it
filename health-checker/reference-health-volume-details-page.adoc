...
** Protetto da
+
Visualizza il tipo di protezione utilizzato per il volume selezionato. Questo campo fornisce anche un link che reindirizza l'utente alla pagina delle relazioni con le relazioni di disaster recovery delle macchine virtuali dello storage. Il link è applicabile solo alle relazioni costitutive.
