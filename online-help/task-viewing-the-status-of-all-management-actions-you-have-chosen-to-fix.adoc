...
. Fare clic su *azioni di gestione* nel riquadro di navigazione a sinistra. In alternativa, fare clic su image:../media/more-icon.gif[""] Nella parte superiore del pannello *azioni di gestione* del pannello *Dashboard* e selezionare la vista che si desidera visualizzare.
+
