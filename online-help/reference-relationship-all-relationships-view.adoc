...
+
Visualizza il tipo di oggetto utilizzato nella relazione.
...
* *Nodo di origine*
+
Visualizza il nome del collegamento del nome del nodo di origine per la relazione SnapMirror di un volume e il collegamento del numero di nodi di relazione SnapMirror quando l'oggetto è una Storage VM.

+
Quando si fa clic sul collegamento del numero di nodi, viene visualizzata la pagina del nodo con i rispettivi nodi associati a tali relazioni. Quando il numero di nodi è 0, non viene visualizzato alcun valore in quanto non vi sono nodi associati alla relazione.

* *Nodo di destinazione*
+
Visualizza il nome del collegamento del nome del nodo di destinazione per la relazione SnapMirror di un volume e il collegamento del numero di nodi di relazione SnapMirror quando l'oggetto è una Storage VM.
