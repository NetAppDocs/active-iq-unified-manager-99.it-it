...
. Salvare la vista con un nome specifico che rifletta ciò che viene visualizzato, ad esempio "`Qtree quasi pieni`", quindi fare clic sul segno di spunta (image:../media/blue-check.gif[""]).
